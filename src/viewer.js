...
import { DirectionalLightHelper, SpotLightHelper, Vector2 } from './three.module.js';
...
export class Viewer {
  ...
  constructor (el, options) {
    ...
    this.state = {
      ...
      Hx: new Vector3(1, 0, 0),
      Hy: new Vector3(0, 1, 0),
      Hz: new Vector3(0, 0, 1),
      Sx: new Vector3(1, 0, 0),
      Sy: new Vector3(0, 1, 0),
      Sz: new Vector3(0, 0, 1),
  ...
  addLights () {
    ...
    const light2  = new DirectionalLight(state.directColor, state.directIntensity, state.x, state.y, state.z);
    ...
    const helper2 = new DirectionalLightHelper(light2);
    this.defaultCamera.add( helper2 );
    ...
    const helper3 = new HemisphereLightHelper(light3);
    this.defaultCamera.add( helper3 );
    ...
    const helper4 = new SpotLightHelper(light4);
    this.defaultCamera.add(helper4);
    ...
    const helper5 = new PointLightHelper(light5);
    this.defaultCamera.add(helper5);
  ...
  addGUI () {
    ...
    [
      ...
      directionFolder.add(this.state, 'Dx', -50, 50),
      directionFolder.add(this.state, 'Dy', -50, 50),
      directionFolder.add(this.state, 'Dz', -50, 50)
    ].forEach((ctrl) => ctrl.onChange(() => this.updateLights()));
    ...
    [
      ...
      SpotFolder.add(this.state, 'Sx', -50, 50),
      SpotFolder.add(this.state, 'Sy', -50, 50),
      SpotFolder.add(this.state, 'Sz', -50, 50)
    ].forEach((ctrl) => ctrl.onChange(() => this.updateLights()));
    ...
    [
      ...
      HemisphereFolder.add(this.state, 'Hx', -50, 50),
      HemisphereFolder.add(this.state, 'Hy', -50, 50),
      HemisphereFolder.add(this.state, 'Hz', -50, 50)
    ].forEach((ctrl) => ctrl.onChange(() => this.updateLights()));
    ...
    [
      ...
      PointFolder.add(this.state, 'Px', -50, 50),
      PointFolder.add(this.state, 'Py', -50, 50),
      PointFolder.add(this.state, 'Pz', -50, 50)
    ].forEach((ctrl) => ctrl.onChange(() => this.updateLights()));
